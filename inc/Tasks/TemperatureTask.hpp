...
public:
    ...
    TemperatureTask(Parameter<float>& parameter, Parameter<SystemParameters::TemperatureStatus>& statusParameter, uint8_t sensorI2c, PIO_PIN sensorPin, PIO_PIN buttonPin);
private:
